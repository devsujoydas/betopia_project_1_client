        ...
        <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-14 px-5 md:px-10 pt-10 pb-20">
          ...
          >
            ...
            <div className="flex justify-center lg:justify-start">
              <Link to={"/client/dashboard"} className="flex items-center gap-2 bg-[#DBCBB9] text-black px-4 sm:px-5 py-2 rounded-md cursor-pointer border border-transparent hover:bg-transparent hover:text-[#DBCBB9] hover:border-[#DBCBB9] transition-all duration-300 active:scale-95">
